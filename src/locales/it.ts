...
export const it = {
  ...
  footer: {
    description: "Azienda professionale di sviluppo web e app mobile che fornisce soluzioni digitali innovative per aiutare le aziende a crescere e avere successo online.",
  ...
  testimonials: {
    ...
    description: "Scopri perché le aziende si fidano di AppWorkSolutions per le loro esigenze di trasformazione digitale."
  },
  notFound: {
  ...
  home: {
    ...
    features: {
      ...
      title: "Eccellenza nello Sviluppo",
      description: "Forniamo soluzioni di alta qualità utilizzando le tecnologie più recenti e le migliori pratiche.",
      items: {
        responsive: {
          title: "Design Responsive",
          description: "Approccio mobile-first che garantisce una visualizzazione perfetta su tutti i dispositivi."
        },
        performance: {
          title: "Alte Prestazioni",
          description: "Applicazioni ottimizzate con velocità di caricamento fulminee."
        },
        support: {
          title: "Supporto 24/7",
          description: "Supporto tecnico e servizi di manutenzione 24 ore su 24."
        },
        security: {
          title: "Soluzioni Sicure",
          description: "Misure di sicurezza standard del settore per proteggere i tuoi dati."
        },
        scalable: {
        ...
        modern: {
          ...
          description: "Framework e strumenti più recenti per soluzioni all'avanguardia."
        }
      }
    },
    cta: {
  ...
  services: {
    ...
    subtitle: "Soluzioni digitali complete dal concept al deployment e oltre.",
    categories: {
      web: {
        title: "Sviluppo Web",
        description: "Siti web personalizzati e applicazioni web costruite con tecnologie moderne.",
        items: [
          {
            title: "Siti Web Personalizzati",
            description: "Siti web su misura progettati per rappresentare il tuo brand e coinvolgere il tuo pubblico."
          },
          {
            title: "Soluzioni E-commerce",
            description: "Potenti negozi online con elaborazione sicura dei pagamenti e gestione dell'inventario."
          },
          {
            title: "Applicazioni Web",
            description: "App web complesse con funzionalità avanzate e esperienza utente fluida."
          },
          {
            title: "Sviluppo CMS",
      ...
      mobile: {
        ...
        items: [
          {
            title: "App iOS",
            description: "Applicazioni iOS native ottimizzate per dispositivi iPhone e iPad."
          },
          {
            title: "App Android",
          ...
          },
          {
            ...
            description: "App React Native e Flutter che funzionano perfettamente su entrambe le piattaforme."
          },
          {
            title: "Ottimizzazione App Store",
            description: "Deployment completo e ottimizzazione per la visibilità negli app store."
          }
        ]
      },
      design: {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Prototipi interattivi per validare i concetti prima dello sviluppo."
          },
          {
            title: "Identità del Brand",
            description: "Design completo dell'identità del brand inclusi loghi e guide di stile."
          }
        ]
      },
      consulting: {
        title: "Consulenza IT",
        description: "Consulenza tecnologica strategica per aiutarti a prendere decisioni informate.",
        items: [
          {
          ...
          },
          {
            ...
            description: "Guida la tua azienda attraverso iniziative di trasformazione digitale."
          },
          {
            title: "Revisione del Codice",
            description: "Audit professionali del codice per garantire qualità e migliori pratiche."
          },
          {
            title: "Ottimizzazione delle Prestazioni",
            description: "Ottimizza le applicazioni esistenti per migliori prestazioni ed efficienza."
          }
        ]
      }
    }
  ...
  contact: {
    ...
    weekends: "Weekend: Su appuntamento",
    ...
    thankYou: "Grazie per averci contattato. Risponderemo al tuo messaggio entro 24 ore.",
    faq: "Domande Frequenti",
    faqSubtitle: "Trova risposte rapide alle domande più comuni sui nostri servizi di sviluppo.",
    questions: {
      timeline: {
      ...
      cost: {
        ...
        answer: "I costi dipendono dall'ambito e dai requisiti del progetto. Offriamo prezzi competitivi e forniamo preventivi dettagliati dopo aver compreso le tue esigenze specifiche. Contattaci per una consulenza gratuita."
      },
      technologies: {
